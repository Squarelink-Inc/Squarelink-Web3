var npmLibPackageExample = (function (http, https, url, assert, stream, tty, util, os, zlib) {
  'use strict';
  ...
  var _where = "/Users/alex/Documents/Squarelink/SDKs/npm/Web3";
  var author = {
  	name: "Matt Zabriskie"
  };
  var browser$1 = {
    ...
    return new Promise((resolve, reject) => {
      ...
      window.addEventListener('message', function (e) {
        if (e.data.origin === 'squarelink') {
          ...
          resolve(_extends({}, e.data, { origin: undefined }));
        }
      }, false);
    });
  };
    ...
    getAccounts() {
      return new Promise(async (resolve, reject) => {
        if (this.accounts) {
          ...
          axios$1.get(`${API_ENDPOINT}/wallets`, {
            params: {
              access_token
            }
          }).then(({ data }) => {
